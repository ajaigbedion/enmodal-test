    ...
    $.ajax({ url: "user-maps",
        ...
        success: function(data, status) {
            ...
            for (var i = 0; i < data.maps.length; i++) {
                ...
                $("#user-maps").append('<a href="'+map.url+'" target="_blank"><div class="user-map"><img src="src/img/map-screenshots/'+map.id+'.png?d='+cache_string+'" onerror="if (this.src != \'src/img/map.png\') this.src = \'src/img/map.png\';" /><div class="map-title">'+map.title+'</div><div class="map-actions"><a class="button" data-toggle="modal" data-target="#map-delete-confirm"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</a></div></div></a>');
            }
        }
    });
